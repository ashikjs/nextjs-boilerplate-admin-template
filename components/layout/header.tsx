                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <Link href='/dashboard/user'>
                                    <button
                                        className=" text-white hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">User
                                    </button>
                                </Link>
                                <button
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img className="h-8 w-8 rounded-full"
                                             src="https://images.unsplash.com/photo-1557862921-37829c790f19?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                                             alt=""/>
                                    </button>
                                </div>
